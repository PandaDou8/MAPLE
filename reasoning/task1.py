...
#         self.metric = metric  # Evaluation metric.
...
#
#     # Preprocess train / valid / test splits.
...
#
#             # Enable sample_weight in config to weight negative samples.
#             if self.sample_weight:
...
#         else:
#             # Train mode.
#             # Negative sampling: strict or random.
#             # Strict sampling excludes known valid triples.
